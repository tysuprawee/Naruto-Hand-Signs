...
export const TRANSLATIONS: Record<LanguageCode, TranslationNode> = {
  EN: {
    ...
    quest: {
      ...
      rotatingDirectivesReset: "Rotating directives refresh each daily and weekly UTC reset.",
      resetTracker: "Reset Tracker",
      streakBoostApplies: "Boost applies to every completed jutsu run.",
      dailyMissionRewardPending: "Reward pending",
      dailyMissionNextSuccessfulRun: "on next successful run",
      dailyMissionCompletedToday: "Completed today",
      dailyMissionRemainingToUnlock: "remaining to unlock",
      comebackBoostActive: "Comeback boost active",
      comebackBoostFor: "for",
      runSingular: "run",
      runPlural: "runs",
      ready: "Ready",
      ...
      def: {
        d_signs: { title: "Land 25 correct signs", subtitle: "Any mode contributes to this mission." },
        d_jutsus: { title: "Complete 5 jutsu runs", subtitle: "Steady clears build daily streak momentum." },
        d_xp: { title: "Earn 450 XP", subtitle: "Quest and run rewards both apply." },
        w_jutsus: { title: "Complete 30 jutsu runs", subtitle: "Build volume across the full week." },
        w_challenges: { title: "Finish 12 rank mode runs", subtitle: "Push secure submissions all week." },
        w_xp: { title: "Earn 4000 XP", subtitle: "Quests and runs stack together." },
      },
    },
    play: {
      readyToStart: "READY TO START",
      pressSpaceOrTap: "PRESS [SPACE] OR TAP BUTTON",
      performFast: "Perform the sequence as fast as possible.",
      rankRule1: "Timer starts on GO.",
      rankRule2: "Detect all signs in order.",
      rankRule3: "Timer stops on final sign.",
      startRun: "START RUN",
    },
    run: {
  ...
  JP: {
    ...
    quest: {
      ...
      rotatingDirectivesReset: "デイリー/ウィークリーUTC更新ごとに指令がローテーションします。",
      resetTracker: "リセットトラッカー",
      streakBoostApplies: "ブーストは完了した各術ランに適用されます。",
      dailyMissionRewardPending: "報酬保留",
      dailyMissionNextSuccessfulRun: "次の成功ランで付与",
      dailyMissionCompletedToday: "本日達成",
      dailyMissionRemainingToUnlock: "で解放",
      comebackBoostActive: "カムバックブースト有効",
      comebackBoostFor: "対象",
      runSingular: "ラン",
      runPlural: "ラン",
      ready: "準備完了",
      ...
      def: {
        d_signs: { title: "正しい印を25回成功", subtitle: "どのモードでもこの任務の進行に加算されます。" },
        d_jutsus: { title: "術ランを5回完了", subtitle: "安定したクリアがデイリーストリークを伸ばします。" },
        d_xp: { title: "450 XPを獲得", subtitle: "クエスト報酬とラン報酬の両方が適用されます。" },
        w_jutsus: { title: "術ランを30回完了", subtitle: "1週間を通してクリア数を積み上げましょう。" },
        w_challenges: { title: "ランクモードを12回完了", subtitle: "安全な送信付きの完了を週間で積み上げます。" },
        w_xp: { title: "4000 XPを獲得", subtitle: "クエストとラン報酬は重複して加算されます。" },
      },
    },
    play: {
      readyToStart: "開始準備完了",
      pressSpaceOrTap: "[SPACE] を押すかボタンをタップ",
      performFast: "シーケンスをできるだけ速く実行してください。",
      rankRule1: "GOでタイマー開始。",
      rankRule2: "すべての印を順番どおりに認識。",
      rankRule3: "最後の印でタイマー停止。",
      startRun: "ラン開始",
    },
    run: {
      runErrorTitle: "ランエラー",
  ...
  TH: {
    ...
    quest: {
      ...
      missionControl: "ศูนย์ควบคุมภารกิจ",
      rotatingDirectivesReset: "ภารกิจหมุนเวียนทุกการรีเซ็ตรายวันและรายสัปดาห์ (UTC)",
      resetTracker: "ตัวติดตามรีเซ็ต",
      streakBoostApplies: "บูสต์ใช้กับทุกการเคลียร์คาถาที่สำเร็จ",
      dailyMissionRewardPending: "รางวัลรอดำเนินการ",
      dailyMissionNextSuccessfulRun: "จะได้รับในรอบที่สำเร็จถัดไป",
      dailyMissionCompletedToday: "สำเร็จแล้ววันนี้",
      dailyMissionRemainingToUnlock: "เหลือเพื่อปลดล็อก",
      comebackBoostActive: "บูสต์คัมแบ็กกำลังทำงาน",
      comebackBoostFor: "สำหรับ",
      runSingular: "รอบ",
      runPlural: "รอบ",
      ready: "พร้อม",
      questComplete: "เควสต์สำเร็จ",
      ...
      def: {
        d_signs: { title: "ทำสัญญาณถูกต้อง 25 ครั้ง", subtitle: "ทุกโหมดนับความคืบหน้าภารกิจนี้" },
        d_jutsus: { title: "เล่นคาถาครบ 5 รอบ", subtitle: "เคลียร์ต่อเนื่องช่วยเร่งสตรีคประจำวัน" },
        d_xp: { title: "ได้รับ 450 XP", subtitle: "ได้ทั้งจากเควสต์และรางวัลการเล่นรอบ" },
        w_jutsus: { title: "เล่นคาถาครบ 30 รอบ", subtitle: "สะสมจำนวนเคลียร์ให้ครบตลอดทั้งสัปดาห์" },
        w_challenges: { title: "จบโหมดแรงก์ 12 รอบ", subtitle: "เก็บรอบแรงก์ที่ส่งผลสำเร็จให้ครบในสัปดาห์" },
        w_xp: { title: "ได้รับ 4000 XP", subtitle: "รางวัลจากเควสต์และการเล่นจะรวมกัน" },
      },
    },
    play: {
      readyToStart: "พร้อมเริ่ม",
      pressSpaceOrTap: "กด [SPACE] หรือแตะปุ่ม",
      performFast: "ทำลำดับให้เร็วที่สุด",
      rankRule1: "ตัวจับเวลาเริ่มเมื่อ GO",
      rankRule2: "ตรวจจับสัญญาณมือให้ครบตามลำดับ",
      rankRule3: "ตัวจับเวลาหยุดที่สัญญาณสุดท้าย",
      startRun: "เริ่มรัน",
    },
    run: {
  ...
  VN: {
    ...
    quest: {
      ...
      missionControl: "Trung tam nhiem vu",
      rotatingDirectivesReset: "Nhiem vu xoay vong theo moi lan reset ngay va tuan UTC.",
      resetTracker: "Theo doi reset",
      streakBoostApplies: "Boost ap dung cho moi lan hoan thanh jutsu.",
      dailyMissionRewardPending: "Thuong dang cho",
      dailyMissionNextSuccessfulRun: "se nhan o lan chay thanh cong tiep theo",
      dailyMissionCompletedToday: "Da hoan thanh hom nay",
      dailyMissionRemainingToUnlock: "con lai de mo khoa",
      comebackBoostActive: "Comeback boost dang hoat dong",
      comebackBoostFor: "cho",
      runSingular: "lan",
      runPlural: "lan",
      ready: "San sang",
      questComplete: "Hoan thanh nhiem vu",
      ...
      def: {
        d_signs: { title: "Dat 25 dau an dung", subtitle: "Bat ky che do nao cung dong gop cho nhiem vu nay." },
        d_jutsus: { title: "Hoan thanh 5 lan jutsu", subtitle: "Hoan thanh deu de tang da streak hang ngay." },
        d_xp: { title: "Nhan 450 XP", subtitle: "Thuong quest va thuong run deu duoc tinh." },
        w_jutsus: { title: "Hoan thanh 30 lan jutsu", subtitle: "Tich luy so luong run trong ca tuan." },
        w_challenges: { title: "Hoan thanh 12 lan rank mode", subtitle: "Day manh cac lan nop rank hop le trong tuan." },
        w_xp: { title: "Nhan 4000 XP", subtitle: "Quest va run cong don de dat muc tieu." },
      },
    },
    play: {
      readyToStart: "SAN SANG BAT DAU",
      pressSpaceOrTap: "NHAN [SPACE] HOAC CHAM NUT",
      performFast: "Thuc hien chuoi nhanh nhat co the.",
      rankRule1: "Dong ho bat dau khi GO.",
      rankRule2: "Nhan du cac dau theo dung thu tu.",
      rankRule3: "Dong ho dung o dau cuoi cung.",
      startRun: "BAT DAU RUN",
    },
    run: {
  ...
  FR: {
    ...
    quest: {
      ...
      missionControl: "Controle mission",
      rotatingDirectivesReset: "Les directives tournent a chaque reset quotidien et hebdo UTC.",
      resetTracker: "Suivi reset",
      streakBoostApplies: "Le boost s applique a chaque run jutsu termine.",
      dailyMissionRewardPending: "Recompense en attente",
      dailyMissionNextSuccessfulRun: "sur le prochain run reussi",
      dailyMissionCompletedToday: "Termine aujourd hui",
      dailyMissionRemainingToUnlock: "restant pour debloquer",
      comebackBoostActive: "Boost retour actif",
      comebackBoostFor: "pour",
      runSingular: "run",
      runPlural: "runs",
      ready: "Pret",
      questComplete: "Quete terminee",
      ...
      def: {
        d_signs: { title: "Reussir 25 signes corrects", subtitle: "Tous les modes comptent pour cette mission." },
        d_jutsus: { title: "Completer 5 runs de jutsu", subtitle: "Des clears reguliers renforcent le streak quotidien." },
        d_xp: { title: "Gagner 450 XP", subtitle: "Les recompenses de quetes et de runs s additionnent." },
        w_jutsus: { title: "Completer 30 runs de jutsu", subtitle: "Construis ton volume de runs sur toute la semaine." },
        w_challenges: { title: "Finir 12 runs rank mode", subtitle: "Pousse des soumissions securisees toute la semaine." },
        w_xp: { title: "Gagner 4000 XP", subtitle: "Quetes et runs se cumulent pour progresser plus vite." },
      },
    },
    play: {
      readyToStart: "PRET A COMMENCER",
      pressSpaceOrTap: "APPUYEZ SUR [ESPACE] OU TOUCHEZ LE BOUTON",
      performFast: "Execute la sequence le plus vite possible.",
      rankRule1: "Le chrono demarre a GO.",
      rankRule2: "Detecte tous les signes dans l ordre.",
      rankRule3: "Le chrono s arrete au dernier signe.",
      startRun: "DEMARRER RUN",
    },
    run: {
  ...
  ES: {
    ...
    quest: {
      ...
      missionControl: "Control de mision",
      rotatingDirectivesReset: "Las directivas rotan en cada reinicio diario y semanal UTC.",
      resetTracker: "Seguimiento de reinicio",
      streakBoostApplies: "El boost aplica a cada run de jutsu completado.",
      dailyMissionRewardPending: "Recompensa pendiente",
      dailyMissionNextSuccessfulRun: "en el proximo run exitoso",
      dailyMissionCompletedToday: "Completado hoy",
      dailyMissionRemainingToUnlock: "restante para desbloquear",
      comebackBoostActive: "Boost de regreso activo",
      comebackBoostFor: "por",
      runSingular: "run",
      runPlural: "runs",
      ready: "Listo",
      questComplete: "Mision completada",
      ...
      def: {
        d_signs: { title: "Acierta 25 signos correctos", subtitle: "Cualquier modo aporta progreso a esta mision." },
        d_jutsus: { title: "Completa 5 runs de jutsu", subtitle: "Los clears constantes impulsan la racha diaria." },
        d_xp: { title: "Gana 450 XP", subtitle: "Las recompensas de mision y run se acumulan." },
        w_jutsus: { title: "Completa 30 runs de jutsu", subtitle: "Construye volumen de runs durante toda la semana." },
        w_challenges: { title: "Termina 12 runs de modo rank", subtitle: "Empuja envios verificados durante toda la semana." },
        w_xp: { title: "Gana 4000 XP", subtitle: "Misiones y runs se combinan para avanzar mas rapido." },
      },
    },
    play: {
      readyToStart: "LISTO PARA EMPEZAR",
      pressSpaceOrTap: "PULSA [SPACE] O TOCA EL BOTON",
      performFast: "Realiza la secuencia lo mas rapido posible.",
      rankRule1: "El cronometro empieza en GO.",
      rankRule2: "Detecta todos los signos en orden.",
      rankRule3: "El cronometro se detiene en el ultimo signo.",
  ...
  DE: {
    ...
    play: {
      ...
      pressSpaceOrTap: "DRUCKE [SPACE] ODER TIPPE DEN BUTTON",
      performFast: "Fuhre die Sequenz so schnell wie moglich aus.",
      rankRule1: "Timer startet bei GO.",
      rankRule2: "Erkenne alle Zeichen in der richtigen Reihenfolge.",
      rankRule3: "Timer stoppt beim letzten Zeichen.",
  ...
  ZH: {
    ...
    play: {
      readyToStart: "准备开始",
      pressSpaceOrTap: "按 [SPACE] 或点击按钮",
      performFast: "尽可能快地完成整套结印。",
      rankRule1: "计时在 GO 时开始。",
      rankRule2: "按顺序识别所有手势。",
      rankRule3: "在最后一个手势时停止计时。",
      startRun: "开始挑战",
    },
  },
  KR: {
    ...
    play: {
      ...
      pressSpaceOrTap: "[SPACE]를 누르거나 버튼을 탭하세요",
      performFast: "시퀀스를 최대한 빠르게 수행하세요.",
      rankRule1: "GO에서 타이머가 시작됩니다.",
      rankRule2: "모든 사인을 순서대로 인식하세요.",
      rankRule3: "마지막 사인에서 타이머가 멈춥니다.",
      startRun: "런 시작",
    },
  },
};
